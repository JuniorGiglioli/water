...
export class LoginSession {
    ...
    public createSession( responseAuthorization: ResponseAuthorization ) {
        ...
        let createdTime = String( new Date().getTime() );
    ...
    public isLogged(): boolean {
        ...
        let accessToken: string = localStorage.getItem( Constants.OAUTH.ACCESS_TOKEN );
        let expiresIn = localStorage.getItem( Constants.OAUTH.EXPIRES_IN );
        let createdTime = localStorage.getItem( Constants.OAUTH.CREATED_TIME );
